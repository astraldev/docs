...
Many of the Frontend API examples use API (or native) flows. These flows are used by clients such as mobile devices or native
applications. When building an application for browser clients, use the browser flows instead.  
[Learn more](https://www.ory.sh/docs/identities/native-browser) about the differences when developing browser or native apps.
...
```mdx-code-block
import createLogin from '!!raw-loader!../../../code-examples/sdk/go/selfservice/create-login.go'
...
```mdx-code-block
import createRegistration from '!!raw-loader!../../../code-examples/sdk/go/selfservice/create-registration.go'
...
```mdx-code-block
import createRecovery from '!!raw-loader!../../../code-examples/sdk/go/selfservice/create-recovery.go'
...
```mdx-code-block
import createVerification from '!!raw-loader!../../../code-examples/sdk/go/selfservice/create-verification.go'
...
```mdx-code-block
import getRegistration from '!!raw-loader!../../../code-examples/sdk/go/selfservice/get-registration.go'
...
```mdx-code-block
import getRecovery from '!!raw-loader!../../../code-examples/sdk/go/selfservice/get-recovery.go'
...
```mdx-code-block
import getVerification from '!!raw-loader!../../../code-examples/sdk/go/selfservice/get-verification.go'
...
```mdx-code-block
import submitLogin from '!!raw-loader!../../../code-examples/sdk/go/selfservice/submit-login.go'
...
```mdx-code-block
import submitRegistration from '!!raw-loader!../../../code-examples/sdk/go/selfservice/submit-registration.go'
...
```mdx-code-block
import submitRecovery from '!!raw-loader!../../../code-examples/sdk/go/selfservice/submit-recovery.go'
...
```mdx-code-block
import submitVerification from '!!raw-loader!../../../code-examples/sdk/go/selfservice/submit-verification.go'
...
```mdx-code-block
import whoami from '!!raw-loader!../../../code-examples/sdk/go/selfservice/whoami2.go'

<CodeBlock language="go" title="login.go">{whoami}</CodeBlock>
```
...
```mdx-code-block
import getActiveSessions from '!!raw-loader!../../../code-examples/sdk/go/selfservice/get-active-sessions.go'
...
```mdx-code-block
import logout from '!!raw-loader!../../../code-examples/sdk/go/selfservice/logout.go'
...
```mdx-code-block
import revokeSession from '!!raw-loader!../../../code-examples/sdk/go/selfservice/revoke-session.go'
...
```mdx-code-block
import revokeOtherSessions from '!!raw-loader!../../../code-examples/sdk/go/selfservice/revoke-other-sessions.go'
